        ...
        <tbody>
            <?php foreach ($posts as $p): ?>
                <tr>
                    ...
                    <td>
                        <a href="post_view.php?id=<?php echo $p['id']; ?>" class="fw-bold text-body text-decoration-none">
                            <?php echo htmlspecialchars($p['title']); ?>
                        </a>
                    </td>

                    <td class="text-nowrap">
                        <a href="post_info.php?id=<?php echo $p['id']; ?>" class="btn btn-sm btn-outline-primary">修改</a>
