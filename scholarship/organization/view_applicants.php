        ...
        <?php foreach ($rows as $row): ?>
            ...
            <div class="col">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        <h5 class="card-title">申請學生：<?php echo h($row['student_name']); ?></h5>
                        ...
                        <?php else: ?>
                            <p><strong>推薦信內容：</strong><br><?php echo nl2br(h($row['recommendation'])); ?></p>
                        <?php endif; ?>
                                ...
                                <?php foreach ($autobiFiles as $f): ?>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <?php if (strpos($f['path'], '/scholarship/file_view.php?id=') === 0): ?>
                                            <a href="<?= h($f['path']) ?>" target="_blank" class="btn btn-sm btn-outline-secondary">下載</a>
                                        <?php else: ?>
