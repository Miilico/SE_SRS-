...
if ($id) {
    ...
    $stmt = $pdo->prepare("SELECT * FROM announcement WHERE ID = ? AND AID = ?");
...
<?php require __DIR__ . "/../header.php"; ?>
    ...
    <div class="card border-0 shadow-sm">
        ...
        <form method="post" action="org_post_process.php" enctype="multipart/form-data" class="vstack gap-3">
            ...
            <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <a href="org_post_management.php" class="btn btn-outline-secondary">取消</a>
            </div>
        </form>
        </div>
    </div>
